...
Привет👋
Я AI-ассистент школы программирования KiberOne 🤖. Я могу помочь Вам с записью на занятия и отвечу на все сопутствующие вопросы.

Для начала, расскажите, пожалуйста, о вашем ребенке:
    ...
    async with httpx.AsyncClient() as client:
        try:
            ...
            completion_text = (
                ...
                "❓ Теперь вы можете задавать вопросы о нашей школе! Пишите их прямо в чат!\n\n"
                "✏️ Если вы хотите записатся на занятие, нажмите <b>Записаться на занятие</b>! И мы вам перезвоним!\n\n"
                "📞 Если вы хотите связаться с менеджером, то нажмите <b>Позвать администратора</b>! И администратор напишет Вам в телеграмм в ближайшее время!"
